...
import static profileSetting.profileKasir.alamat_kasir_form3;
import static profileSetting.profileKasir.hakakses_detail_form3;
import static profileSetting.profileKasir.id_detail_kasir_form3;
import static profileSetting.profileKasir.nama_kasir_form3;
import static profileSetting.profileKasir.nomor_telfon_kasir_form3;
import static profileSetting.profileKasir.password_detail_form3;
import static profileSetting.profileKasir.username_kasir_detail_form3;
...
public class kasir extends javax.swing.JFrame {
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        try {
            String sql = "SELECT * FROM user WHERE nama = '" + profileKS.getText() + "'";
            ...
            if (rs.next()) {
                ...
                nama_kasir_form3.setText(rs.getString(2));
                id_detail_kasir_form3.setText(rs.getString(1));
                alamat_kasir_form3.setText(rs.getString(5));
                nomor_telfon_kasir_form3.setText(rs.getString(6));
                username_kasir_detail_form3.setText(rs.getString(3));
                password_detail_form3.setText(rs.getString(4));
                hakakses_detail_form3.setText(rs.getString(7));
                dispose();
            }
        } catch (Exception e) {
        }
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        // TODO add your handling code here:
        new fiturBantuanKasir().setVisible(true);
        this.dispose();
